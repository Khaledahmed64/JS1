 ...
 function deleteBookmark(d) {
   tableContent.innerHTML = "";
   var deletedIndex = d.target.dataset.index;
 ...
 function visitWebsite(v) {
   var websiteIndex = v.target.dataset.index;
